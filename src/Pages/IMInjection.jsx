...
const IMInjection = () => {
  ...
  // Safely get IM injection nurses or empty array if not available
  const imNurses = nurses?.im || [];
  ...
  const handleSort = (criteria) => {
    setSortBy(criteria);
    const sorted = [...imNurses].sort((a, b) => {
      switch (criteria) {
  ...
  const handleSearch = (e) => {
    ...
    const filtered = imNurses.filter(nurse => 
  ...
  const handleFilter = (filter) => {
    ...
    if (filter === 'available') {
      ...
      filtered = filtered.filter(nurse => nurse.certifications?.includes('Pediatric Specialist'));
    }
  ...
  return (
    ...
    >
      ...
      >
        <div className="max-w-3xl relative z-10">
          <div className="flex items-center mb-3">
            <h1 className="text-3xl font-bold text-gray-900 mr-3">At-Home IM Injection Services</h1>
        ...
        <div className="absolute right-0 top-0 h-full opacity-20">
          <svg className="h-full w-auto" viewBox="0 0 200 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M50 50H70M70 50L90 30M90 30L110 50M110 50L130 30M130 30L150 50" stroke="#4F46E5" strokeWidth="2" strokeLinecap="round"/>
            <path d="M80 70L100 90L120 70" stroke="#4F46E5" strokeWidth="2" strokeLinecap="round"/>
          </svg>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
          <div className="text-sm text-gray-500">Patient Comfort</div>
          <div className="text-2xl font-bold text-green-600">98%</div>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
          <div className="text-sm text-gray-500">Available Now</div>
          <div className="text-2xl font-bold text-blue-600">{imNurses.filter(n => n.available_now).length}</div>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
      ...
      >
          ...
          <div className="flex items-center">
            ...
            <div className="hidden sm:flex space-x-2">
              ...
              <button
                ...
                className={`px-3 py-1 rounded-full text-sm ${activeFilter === 'pediatric' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-700'}`}
              >
        ...
        <div className="sm:hidden mt-4 flex space-x-2 overflow-x-auto pb-2">
          ...
          <button
            onClick={() => handleFilter('pediatric')}
            className={`px-3 py-1 rounded-full text-sm whitespace-nowrap ${activeFilter === 'pediatric' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-700'}`}
          >
            Pediatric
          </button>
        </div>
            ...
            filteredNurses.map((nurse, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Certification Badge */}
                  {nurse.certifications?.includes('Pediatric Specialist') && (
