...
const ABG = () => {
  ...
  const [selectedService, setSelectedService] = useState('collection');

  // Safely get ABG nurses or empty array if not available
  const abgNurses = nurses?.abg || [];
  ...
  const servicePricing = {
    collection: {
      name: "ABG Collection Only",
      price: "₹350",
      description: "Basic arterial blood gas sample collection"
    },
    collectionWithReport: {
      name: "ABG Collection + Report",
      price: "₹2000",
      description: "Collection with detailed analysis report"
    }
  };

  const handleSort = (criteria) => {
    setSortBy(criteria);
    const sorted = [...abgNurses].sort((a, b) => {
      switch (criteria) {
  ...
  const handleSearch = (e) => {
    ...
    const filtered = abgNurses.filter(nurse => 
  ...
  const handleFilter = (filter) => {
    ...
    if (filter === 'available') {
      ...
      filtered = filtered.filter(nurse => nurse.certifications?.includes('ABG Specialist'));
    }
    ...
    >
      ...
      >
        <div className="max-w-3xl relative z-10">
          <div className="flex items-center mb-3">
            <h1 className="text-3xl font-bold text-gray-900 mr-3">At-Home ABG Services</h1>
        ...
        <div className="absolute right-0 top-0 h-full opacity-20">
          <svg className="h-full w-auto" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M50 100L150 100M100 50L100 150M85 85L115 115M115 85L85 115" stroke="#4F46E5" strokeWidth="8" strokeLinecap="round"/>
          </svg>
        </div>
      </motion.div>
      ...
      >
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="text-2xl font-bold text-purple-600">22 min</div>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
          ...
          <div className="text-2xl font-bold text-blue-600">{abgNurses.filter(n => n.available_now).length}</div>
        </div>
        <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
            ...
            filteredNurses.map((nurse, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Certification Badge */}
                  {nurse.certifications?.includes('ABG Specialist') && (
